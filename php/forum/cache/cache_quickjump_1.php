...
?><form id="qjump" method="get" accept-charset="utf-8" action="http://localhost/TheBloodAmbulance/php/forum/viewforum.php">
	<div class="frm-fld frm-select">
		...
		<span class="frm-input"><select id="qjump-select" name="id">
			...
			<optgroup label="Art! Culture! PR)N!">
				<option value="11"<?php echo ($forum_id == 11) ? ' selected="selected"' : '' ?>>Pixiv Artist Features!~</option>
				<option value="12"<?php echo ($forum_id == 12) ? ' selected="selected"' : '' ?>>Japan... NIPPON! Culture and Everything</option>
				<option value="13"<?php echo ($forum_id == 13) ? ' selected="selected"' : '' ?>>Er*. Pr)n. L*lis</option>
			</optgroup>
		</select>
...
(function () {
	var forum_quickjump_url = "http://localhost/TheBloodAmbulance/php/forum/viewforum.php?id=$1";
