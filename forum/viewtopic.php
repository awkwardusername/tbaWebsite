...
if (!empty($posts_id))
{
    ...
    <div class="<?php echo implode(' ', $forum_page['item_status']) ?>">
        ...
        <div class="postbody<?php if ($cur_post['is_online'] == $cur_post['poster_id'])
            echo ' online'; ?>">
            ...
            <div class="post-entry">
                <h4 id="pc<?php echo $cur_post['id'] ?>"
                    class="entry-title hn"><?php echo $forum_page['item_subject'] ?></h4>
...
<div id="brd-qpost" class="main-content main-frm">
    <?php if (!empty($forum_page['text_options']))
    ...
    <form class="frm-form frm-ctrl-submit" method="post" accept-charset="utf-8"
        ...
        <fieldset class="frm-group group1">
            <legend class="group-legend"><strong><?php echo $lang_common['Write message legend'] ?></strong>
            </legend>
            ...
            <div class="txt-set set1">
                <div class="txt-box textarea required">
                    ...
                    <div class="txt-input"><span class="fld-input"><textarea id="fld1" name="req_message" rows="7"
                                                                             cols="95" required
                                                                             spellcheck="true"></textarea></span>
                    </div>
                </div>
            </div>
        ...
        <div class="frm-buttons">
            ...
            <span class="submit"><input type="submit" name="preview"
                                        value="<?php echo $lang_common['Preview'] ?>"/></span>
        </div>
    </form>
</div>
<?php
