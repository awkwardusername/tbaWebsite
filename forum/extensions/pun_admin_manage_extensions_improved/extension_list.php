...
// Hotfixes list
    ...
    <?php
        ...
        ?>
    <div class="main-head collapsable<?php if (in_array("ext-available", $collapsed))
        echo ' collapsed' ?>" id="ext-available">
    ...
    <div class="main-content main-frm main-extensions<?php if (in_array("ext-available", $collapsed))
        echo ' hidden' ?> ext-available">
...
<?php
    ...
    <div class="main-head collapsable<?php if (in_array("ext-installed", $collapsed))
        echo ' collapsed' ?>" id="ext-installed">
        <p class="options toggler"><span><!-- --></span></p>

        <h2 class="hn"><span><?php echo $lang_admin_ext['Installed extensions'] ?></span></h2>
    </div>
	<div class="main-content main-frm main-extensions<?php if (in_array("ext-installed", $collapsed))
        echo ' hidden' ?> ext-installed">
		<form method="post" accept-charset="utf-8"
              action="<?php echo $base_url ?>/admin/extensions.php?section=manage&amp;multy">
        ...
        if (isset($display_group_buttons) && $display_group_buttons && !empty($inst_exts)) {
            ...
            <div class="hidden">
                <input type="hidden" name="csrf_token"
                       value="<?php echo generate_form_token($base_url . '/admin/extensions.php?section=manage&amp;multy') ?>"/>
            </div>
            <div class="frm-buttons">
                <span class="submit"><input type="submit" name="disable_selected"
                                            value="<?php echo $lang_pun_man_ext_improved['Button disable'] ?>"/></span>
                <span class="submit"><input type="submit" name="enable_selected"
                                            value="<?php echo $lang_pun_man_ext_improved['Button enable'] ?>"/></span>
                <span class="submit"><input type="submit" name="uninstall_selected"
                                            value="<?php echo $lang_pun_man_ext_improved['Button uninstall'] ?>"/></span>
            </div>
