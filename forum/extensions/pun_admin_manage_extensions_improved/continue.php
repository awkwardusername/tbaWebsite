    ...
    <form class="frm-form" method="post" accept-charset="utf-8" action="<?php echo $forum_page['form_action']; ?>">
        ...
        <div class="ct-box error-box">
            ...
            <ul class="error-list">
                ...
                foreach ($dependencies_error as $dep => $main)
                {
                    ...
                    ?>
                    <li class="warn">
                        <span><?php echo sprintf($lang_pun_man_ext_improved['Work dependencies'], $dep, implode(', ', $main)); ?></span>
                    </li>
                    <?php
        ...
        <fieldset class="frm-group group1">
            <fieldset class="mf-set set1">
                ...
                <div class="mf-box">
                    <div class="mf-item">
                        <span class="fld-input"><input type="radio" id="fld0" name="<?php echo $type; ?>_type"
                                                       value="0"/></span>
                        <label for="fld0"><?php echo $lang_pun_man_ext_improved['Ignore deps']; ?></label>
                    </div>
                    <div class="mf-item">
                        <span class="fld-input"><input type="radio" id="fld1" name="<?php echo $type; ?>_type" value="1"
                                                       checked="checked"/></span>
                        <label for="fld1"><?php if ($type == 'disable')
                            echo $lang_pun_man_ext_improved['Disable deps extensions']; if ($type == 'enable')
                            echo $lang_pun_man_ext_improved['Enable main']; if ($type == 'uninstall')
                            echo $lang_pun_man_ext_improved['Disable deps extensions']?></label>
                    </div>
                    <?php if ($type == 'uninstall'): ?>
                    <div class="mf-item">
                        <span class="fld-input"><input type="radio" id="fld1" name="<?php echo $type; ?>_type"
                                                       value="2"/></span>
