<?php
    ...
    class Pun_poll {
        ...
        public static function show_form($question, $poll_answers, $options_count, $days_poll, $votes_poll, $read_unvote_users, $revote, $show_edit_poll_options = FALSE) {
            ...
            ?>
        <fieldset id="pun_poll_switcher_block"
                  class="frm-group group<?php echo ++$forum_page['group_count']; echo ((!$poll_switcher_block_visible) ? ' hidden' : ''); ?>">
            <span class="js_link" id="pun_poll_switcher_link"
                  data-lang-hide="<?php echo forum_htmlencode($lang_pun_poll['Hide poll']); ?>"
                  data-lang-show="<?php echo forum_htmlencode($lang_pun_poll['Show poll']); ?>"><?php echo forum_htmlencode((!$poll_block_open) ? $lang_pun_poll['Show poll'] : $lang_pun_poll['Hide poll']); ?></span>
        </fieldset>
        ...
        <div id="pun_poll_form_block" style="display: <?php echo (($poll_block_open) ? 'block' : 'none'); ?>;">
            <fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
                <div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					...
					<span class="fld-input">
						<input type="text" id="quest" name="question_of_poll" size="70" maxlength="150"
                               value="<?php echo forum_htmlencode($question); ?>">
					</span>
                    </div>
                </div>
                <?php
                ...
                for ($opt_num = 0; $opt_num < $options_count; $opt_num++):
                    ?>
                    <div class="sf-set set<?php echo ++$forum_page['item_count']; echo (($opt_num === 0) ? ' prepend-top' : '');  ?>"
                         data-item-count="<?php echo $forum_page['item_count'] ?>"
                         data-fld-count="<?php echo ++$forum_page['fld_count'] ?>">
                        <div class="sf-box text">
                            <label for="fld<?php echo $forum_page['fld_count'] ?>">
                            ...
                            <br/>
						<span class="fld-input">
							<input id="fld<?php echo $forum_page['fld_count'] ?>" type="text" name="poll_answer[]"
                                   size="35" maxlength="70"
                                   value="<?php echo ($poll_answers != NULL && isset($poll_answers[$opt_num]) ? forum_htmlencode($poll_answers[$opt_num]) : '') ?>"/>
						</span>
                        </div>
                    </div>
                    <?php
                ...
                <span class="js_link"
                      id="pun_poll_add_options_link"><?php echo $lang_pun_poll['Add poll option']; ?></span>
            </fieldset>

            <fieldset id="pun_poll_update_block"
                      class="hidden frm-group frm-hdgroup group<?php echo ++$forum_page['group_count'] ?>">
                <fieldset class="mf-set set<?php echo ++$forum_page['item_count'] ?> mf-head">
                    ...
                    <div class="mf-box">
						...
						<span class="fld-input">
							<input id="fld<?php echo ++$forum_page['fld_count'] ?>" type="text" name="poll_ans_count"
                                   size="5" maxlength="5" value="<?php echo $options_count ?>">
						</span>
                        </div>
                        <div class="mf-field">
						<span class="submit">
            ...
            <fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
                ...
                <div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
					...
					<span class="fld-input">
						<input type="checkbox" id="first_option" value="1"
                               name="read_unvote_users" <?php echo isset($_POST['read_unvote_users']) || $read_unvote_users ? 'checked' : '' ?>/>
					</span>
                        <label for="fld<?php echo $forum_page['fld_count'] ?>">
                ...
                <div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
                    <div class="sf-box checkbox">
					<span class="fld-input">
						<input type="checkbox" id="second_option" value="1"
                               name="revouting" <?php echo isset($_POST['revouting']) || $revote ? 'checked' : '' ?>/>
					</span>
                        <label for="fld<?php echo $forum_page['fld_count'] ?>">
                ...
                <div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
                    <div class="sf-box text">
                        ...
                        <br/>
					<span class="fld-input">
						<input id="fld<?php echo $forum_page['fld_count'] ?>" type="text" name="allow_poll_days"
                               size="5" maxlength="5" value="<?php echo $days_poll; ?>">
					</span>
                    </div>
                </div>
                <div class="sf-set set<?php echo ++$forum_page['item_count'] ?>">
                    <div class="sf-box text">
                        ...
                        <br/>
					<span class="fld-input">
						<input id="fld<?php echo $forum_page['fld_count'] ?>" type="text" name="allow_poll_votes"
                               size="5" maxlength="5"
                               value="<?php echo ($votes_poll == NULL) ? ('') : ($votes_poll); ?>">
					</span>
                    </div>
                </div>
            </fieldset>
            ...
            <fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
                <div class="sf-set set1">
                    <div class="sf-box checkbox">
					<span class="fld-input">
						<input id="fld<?php echo ++$forum_page['fld_count'] ?>" type="checkbox" value="1"
                               name="reset_poll"/>
					</span>
                        <label for="fld<?php echo $forum_page['fld_count'] ?>">
