...
else if (isset($_GET['del_forum']))
{
    ...
    <div class="main-subhead">
        <h2 class="hn">
            <span><?php printf($lang_admin_forums['Confirm delete forum'], forum_htmlencode($forum_name)) ?></span></h2>
    </div>
    <div class="main-content main-frm">
        <form class="frm-form" method="post" accept-charset="utf-8"
            ...
            <div class="frm-buttons">
                <span class="submit primary"><input type="submit" name="del_forum_comply"
...
<div class="main-content main-frm">
    <form method="post" class="frm-form" accept-charset="utf-8"
        ...
        <fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
            <legend class="group-legend"><strong><?php echo $lang_admin_forums['Edit forum details legend'] ?></strong>
            </legend>
            ...
            <div class="txt-set set<?php echo ++$forum_page['item_count'] ?>">
                <div class="txt-box textarea">
                    ...
                    <div class="txt-input"><span class="fld-input"><textarea
                            ...
                            cols="50"><?php echo forum_htmlencode($cur_forum['forum_desc']) ?></textarea></span></div>
                </div>
            </div>
...
// Reset fieldset counter
        ...
        <fieldset class="frm-group group<?php echo ++$forum_page['group_count'] ?>">
            <legend class="group-legend"><strong><?php echo $lang_admin_forums['Edit forum perms legend'] ?></strong>
            </legend>
            <?php
                    ...
                    <div class="mf-box mf-yesno">
                        ...
                        <div class="mf-item">
                            ...
                            <span class="fld-input"><input type="checkbox"
                                                           ...
                                                           value="1"<?php if ($read_forum) echo ' checked="checked"'; echo ($cur_perm['g_read_board'] == '0') ? ' disabled="disabled"' : ''; ?> /></span>
                        ...
                        <div class="mf-item">
                            ...
                            <span class="fld-input"><input type="checkbox"
                                                           ...
                                                           value="1"<?php if ($post_replies) echo ' checked="checked"'; echo ($cur_forum['redirect_url'] != '') ? ' disabled="disabled"' : ''; ?> /></span>
                        ...
                        <div class="mf-item">
                            ...
                            <span class="fld-input"><input type="checkbox"
                                                           ...
                                                           value="1"<?php if ($post_topics) echo ' checked="checked"'; echo ($cur_forum['redirect_url'] != '') ? ' disabled="disabled"' : ''; ?> /></span>
...
<div class="main-content main-frm">
    <form class="frm-form" method="post" accept-charset="utf-8"
        ...
        <div class="frm-buttons">
            <span class="submit"><input type="submit" name="add_forum"
...
<?php
            ...
            ?>
            <fieldset id="forum<? echo $cur_forum['fid']; ?>"
                ...
                <div class="mf-box">
                    ...
                    <div class="mf-field">
                        ...
                        <span class="fld-input"><input type="number" id="fld<?php echo $forum_page['fld_count'] ?>"
                                                       ...
                                                       maxlength="3" value="<?php echo $cur_forum['disp_position'] ?>"/></span>
                    </div>
                </div>
        ...
        <div class="frm-buttons">
            <span class="submit"><input type="submit" name="update_positions"
