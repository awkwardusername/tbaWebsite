...
<div class="main-content main-frm">
    ...
    <form class="frm-form" method="post" accept-charset="utf-8"
        ...
        <div class="frm-buttons">
            <span class="submit primary"><input type="submit" name="delete_users_comply"
...
<div class="main-content main-frm">
    ...
    <form class="frm-form" method="post" accept-charset="utf-8"
        ...
        <div class="frm-buttons">
            <span class="submit"><input type="submit" name="ban_users_comply"
...
<div class="frm-buttons">
    <span class="submit"><input type="submit" name="find_user"
